...
class RoomContextHandler:
    ...
    async def get_event_context(
        ...
        if self._compact_edits_enabled:
            events_before = await self._relations_handler.collapse_superseded_replace_events(
                events_before
            )
            events_after = await self._relations_handler.collapse_superseded_replace_events(
                events_after
            )
